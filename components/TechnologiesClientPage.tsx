...
export default function TechnologiesClientPage() {
  const paramsFromRoute = useParams() as { lang?: string }
  const params = { lang: paramsFromRoute.lang || "pt" }
  ...
  const technologies = [
    ...
    },
    {
      ...
      description:
        params.lang === "pt"
          ? "Esta tecnologia combina o microagulhamento tradicional com a energia de radiofreência, que é liberada diretamente nas camadas mais profundas da pele. O calor gerado pela radiofrequência potencializa a produção de colágeno e elastina, proporcionando resultados superiores ao microagulhamento convencional."
            ...
            <div className="max-w-5xl mx-auto">
              {technologies.map((tech, index) => (
                <div
                  key={tech.id}
                  id={tech.id}
                  className={`mb-12 ${index % 2 === 0 ? "lg:flex-row" : "lg:flex-row-reverse"} flex flex-col lg:flex-row items-center gap-10`}
                >
                  <div className="lg:w-1/2">
                    {tech.additionalImage ? (
                      <div className="grid grid-cols-1 gap-4">
                        ...
                        >
                          <img src={tech.image || "/placeholder.svg"} alt={tech.title} className="object-cover w-full h-full" />
                        </div>
                        <div
                      ...
                      <div className="relative h-80 w-full rounded-xl overflow-hidden shadow-md cursor-pointer" onClick={() => openLightbox(tech.image)}>
                        <img src={tech.image || "/placeholder.svg"} alt={tech.title} className="object-cover w-full h-full" />
                      </div>
                    )}
                  </div>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="heading-md mb-6" style={{ color: "#2E2E2E" }}>
                {params.lang === "pt" ? "Agende uma consulta para avaliação personalizada" : "Schedule a consultation for personalized assessment"}
              </h2>
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-700 mb-8">
                {params.lang === "pt" ? "Encontre respostas para as dúvidas mais comuns sobre nossos tratamentos e tecnologias" : "Find answers to the most common questions about our treatments and technologies"}
              </p>
              <Link
      ...
      {lightboxImage && (
        <div className="fixed inset-0 bg-black bg-opacity-90 z-50 flex items-center justify-center p-4" onClick={closeLightbox}>
          <div className="relative max-w-4xl max-h-[90vh] w-full h-full flex items-center justify-center">
            <button className="absolute top-4 right-4 text-white bg-black bg-opacity-50 rounded-full p-2 z-10" onClick={closeLightbox} aria-label="Close lightbox">
