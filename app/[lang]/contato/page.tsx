...
export default function ContactPage() {
  ...
  useEffect(() => {
    ...
    script.innerHTML = JSON.stringify({
      ...
      "@type": "ContactPage",
      name: "Contato | Dr. Henrique Oliveira",
      description: "Entre em contato com Dr. Henrique Oliveira para agendar sua consulta em Coimbra ou Viseu.",
      mainEntity: {
  ...
  return (
    <>
      <Head>
        <title>Contato | Dr. Henrique Oliveira</title>
        <meta
          name="description"
          content="Entre em contato com Dr. Henrique Oliveira para agendar sua consulta em Coimbra ou Viseu."
        />
      </Head>
