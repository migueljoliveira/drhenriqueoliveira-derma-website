...
export async function generateMetadata({ params }: { params: { lang: string } }): Promise<Metadata> {
  ...
  return {
    ...
    description,
    alternates: {
      canonical: `https://drhenriqueoliveira.com/${params.lang}/technologies`,
      languages: {
        en: "https://drhenriqueoliveira.com/en/technologies",
        pt: "https://drhenriqueoliveira.com/pt/tecnologias",
      },
    },
    openGraph: {
      title,
      description,
      url: `https://drhenriqueoliveira.com/${params.lang}/technologies`,
...
export default function TechnologiesPage({ params }: { params: { lang: string } }) {
  return <TechnologiesClientPage params={params} />
}
